...
$opts = array(
	...
	'roots' => array(
		...
		array(
			...
			'path'          => '../public/assets/files/',                 // path to files (REQUIRED)
			'URL'           => dirname($_SERVER['PHP_SELF']) . '/../public/assets/files/', // URL to files (REQUIRED)
		...
		array(
			'id'            => '1',
			'driver'        => 'Trash',
			'path'          => '../public/assets/.trash/',
			'tmbURL'        => dirname($_SERVER['PHP_SELF']) . '/../public/assets/.trash/.tmb/',
			'winHashFix'    => DIRECTORY_SEPARATOR !== '/', // to make hash same to Linux one on windows too
